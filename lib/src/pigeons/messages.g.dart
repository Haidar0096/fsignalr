...
class HubConnectionManagerNativeApi {
  ...
  Future<HubConnectionStateMessage> getConnectionState(HubConnectionManagerIdMessage msg) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.fsignalr.HubConnectionManagerNativeApi.getConnectionState$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    if (pigeonVar_replyList == null) {
      ...
      return (pigeonVar_replyList[0] as HubConnectionStateMessage?)!;
    }
  }
